...
type PickupAttemptFailedModalProps = {
...
const PickupAttemptFailedModal = ({
  assignment,
  isSaving,
  onClose,
  onSubmit
}: PickupAttemptFailedModalProps) => {
    ...
    try {
      ...
      const message =
        error instanceof Error
          ? error.message
          : "Failed to submit pickup attempt reason.";
            ...
            <form onSubmit={(e) => void handleSubmit(e)}>
              ...
              <div className="modal-body">
                ...
                <div className="alert alert-warning small mb-3">
                  Please provide a reason why this pickup attempt could not be
                  completed. This will update the task log and return pickup
                  status.
                </div>
                ...
                {selectedReason === "Other" ? (
                  <div className="mb-3">
                    ...
                    <textarea
                      ...
                      placeholder="Enter failed pickup attempt reason..."
                    />
...
export default PickupAttemptFailedModal;